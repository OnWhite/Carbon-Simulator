...
def fetch_data(log_file_path="/Users/work/PycharmProjects/Carbon-Simulator/tax_allocation_log.json"):
...
if __name__ == "__main__":
    ...
    open("/Users/work/PycharmProjects/Carbon-Simulator/tax_allocation_log.json", 'w').close()
